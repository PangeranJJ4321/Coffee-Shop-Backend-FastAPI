...
class CoffeeMenuService:
    ...
    def create_coffee_menu(self, coffee_menu: CoffeeMenuCreate) -> CoffeeMenuModel:
        ...
        db_coffee_menu = CoffeeMenuModel(**coffee_menu.dict())
    ...
    def update_coffee_menu(self, coffee_id: UUID, coffee_menu: CoffeeMenuUpdate) -> CoffeeMenuModel:
        """Update a coffee menu item"""
        coffee = self.get_coffee_menu_by_id(coffee_id)
        
        # Update coffee menu data
    ...
    def delete_coffee_menu(self, coffee_id: UUID) -> None:
